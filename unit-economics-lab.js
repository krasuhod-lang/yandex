    ...
    return '<details class="ue2-footnote-wrap">' +
      ...
      '<div class="ue2-footnote-panel" role="note">' +
        ...
        '<ul>' +
          ...
          '<li><b>LTV₂</b> — доход за 2 года с retention и кросс-продажами; поэтому Повторные и CRM показываются отдельно от первичного привлечения.</li>' +
        '</ul>' +
        '<h4>Термины</h4>' +
        '<ul>' +
        ...
        '<ul>' +
          ...
          '<li><b>Payback</b> — срок окупаемости вложений в когорту привлечения: первый месяц, когда накопленная маржа покрывает CAC и OPEX этой когорты. Это не общий срок возврата всех инвестиций проекта — он смотрится отдельно в PnL/обзоре.</li>' +
        '</ul>' +
