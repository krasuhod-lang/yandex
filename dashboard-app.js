...
function renderCentrofinans(){
 ...
 const flow=[
  '<b>Шаг 1. Хеширование на нашей стороне.</b> Из базы Центрофинанса формируется witness-таблица: SHA-256(phone+salt), SHA-256(email+salt), SHA-256(passport+salt). Соль уникальна на проект и не выгружается.',
